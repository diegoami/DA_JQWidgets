(function ($, angular, undefined) {
    ...
    function updateSettings(scope, element, attrs, name, parentScope, settings, elementWatchers) {
        var dataWidgets = /(jqxGrid|jqxPivotGrid|jqxTree|jqxMenu|jqxDataTable|jqxTreeGrid|jqxListBox|jqxTreeMap|jqxComboBox|jqxDropDownList|jqxChart)/ig;
    ...
    function AMD(name, properties) {
        ...
        var scripts = {
            ...
            "jqxPivotGrid":
                         {
                             'scripts': ['jqxdatetimeinput.js', 'jqxcalendar.js', 'jqxdragdrop', 'jqxmenu.js', 'jqxtooltip.js', 'jqxscrollbar.js', 'jqxbuttons.js', 'jqxlistbox.js', 'jqxdropdownlist.js', 'jqxcombobox.js', 'jqxcheckbox.js', 'globalize.js'],
                             'deps': {
                                 'jqxpivotgrid.js': ['jqxpivot.js', 'jqxpivotdesigner'],
                                 'jqxdata.js': ['jqxdata.export.js']
                             }
                         },
            "jqxDataTable":
