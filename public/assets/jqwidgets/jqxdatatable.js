(function ($) {
    ...
    $.extend($.jqx._jqxDataTable.prototype, {
        defineInstance: function () {
            ...
            if (this === $.jqx._jqxDataTable.prototype) {
                return settings;
            }
        ...
        ensurerowvisiblebykey: function (key) {
            ...
            if (this.showstatusbar) {
                tableheight -= this.statusBarHeight;
            }
            if (this.showAggregates) {
...
//                    that._renderrows(false);
        ...
        _rendercolumnheaders: function () {
            ...
            if (that.columns.records.length > that.headerZIndex) {
                that.headerZIndex = that.columns.records.length + 10;
            }
