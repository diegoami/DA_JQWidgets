                ...
                proto.setup = function () {
                    ...
                    var createInstance = function (defaultSettings) {
                        ...
                        for (var obj in methods) {
                            ...
                            if (methodName === "resize" || methodName === "scrollWidth" || methodName === "scrollHeight" || methodName === "constructor" || methodName === "createInstance" || methodName === "defineInstance") {
                                continue;
                            }
                        ...
                        if (name === "jqxMaskedInput" || name === "jqxPasswordInput" || name === "jqxButton" || name === "jqxToggleButton" || name === "jqxRepeatButton") {
